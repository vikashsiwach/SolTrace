...
export default function WatchlistScreen() {
  ...
  useEffect(() => {
    if (favourites.length > 0) {
      setItems(
        favourites.map((a) => ({ address: a, balance: null, loading: true }))
      );
      fetchBalances();
    } else {
      setItems([]);
    }
  }, [favourites, fetchBalances]);
    ...
    <SafeAreaView style={s.safe} edges={["top"]}>
      <View style={s.container}>
        ...
        <Text style={s.subtitle}>
          {favourites.length} wallet{favourites.length !== 1 ? "s" : ""} ·{" "}
                  ...
                  Alert.alert(
                    ...
                    [
                      { text: "Cancel", style: "cancel" },
                      {
                        text: "Remove",
                        style: "destructive",
                        onPress: () => removeFavourite(item.address),
                      },
                    ]
                  );
                }}
